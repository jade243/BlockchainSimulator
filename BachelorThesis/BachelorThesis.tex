...
\chapter{Attacks using mining weaknesses}
  ...
  \input{Chapters/Attacks/doubleSpending.tex}

  \input{Chapters/Attacks/selfishMining.tex}

\chapter{Quantum computing and blockchains' security ?}

  \input{Chapters/Quantum/IntroQuantum.tex}

  \input{Chapters/Quantum/quantumHack.tex}
