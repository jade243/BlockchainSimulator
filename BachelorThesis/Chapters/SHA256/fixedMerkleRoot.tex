We know that mining is based on SHA256 so, in this part, we'll see different techniques (inspired by \cite{broken_crypto_primitives}) to win against traditional mining if SHA256 is broken.
